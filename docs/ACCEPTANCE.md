...
| 电子/文件相似 | E-01、S-01、S-02、S-03、S-04、S-05 | E-01 仅电子字段；S-04 仅使用 `COMPARABLE` 的 `comparison_key`；S-05 不写入共享块原文 |
| 主体/关系线索 | P-01、P-02、P-03 | 人员重合和亲属关系只形成人工复核信号 |

全量自动化测试当前为 `314 passed, 1 skipped`；跳过项是 Windows 当前进程无创建符号链接权限，
...
- [x] README
- [x] 测试结果（每轮 PROGRESS.md 记录；当前全量 314 passed、1 skipped，CI 六 job+release 测试门；双平台验收操作单 docs/UAT.md）
